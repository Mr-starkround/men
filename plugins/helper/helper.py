...
class Helper():
    ...
    async def pesan_langganan(self):
        ...
        await self.bot.send_message(self.user_id, ,mention=self.message.from_user.mention, config.pesan_join, reply_to_message_id=self.message.id, reply_markup=markup)
