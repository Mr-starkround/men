...
async def send_menfess_handler(client: Client, msg: types.Message):
    ...
    keyboard = [
 [InlineKeyboardButton(                "👀ʟɪʜᴀᴛ", url=f'https://t.me/testerajaoni/{msg.from_config_channel_1}'),       InlineKeyboardButton(                "🗑ʜᴀᴘᴜs", url=f'tg://deleteMessage?chat_id={msg.from_user.id}')],
]
