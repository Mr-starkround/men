...
async def send_menfess_handler(client: Client, msg: types.Message):
    ...
    keyboard = [
 [InlineKeyboardButton(                "👀ʟɪʜᴀᴛ", url=f'https://t.me/c/str(config.channel_1).split('-100')[1]'),       InlineKeyboardButton(                "🗑ʜᴀᴘᴜs", url=f'tg://deleteMessage?chat_id={msg.from_user.id}')],
]
