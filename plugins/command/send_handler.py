...
async def send_menfess_handler(client: Client, msg: types.Message):
    ...
    keyboard = [
 [InlineKeyboardButton(                "👀ʟɪʜᴀᴛ", url=f'https://t.me/OpenMessage?config.channel_1={client.id_bot}'),       InlineKeyboardButton(                "🗑ʜᴀᴘᴜs", url=f'tg://deleteMessage?chat_id={msg.from_user.id}')],
]
